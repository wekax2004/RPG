...
async function start() {
    console.log("[Main] Starting Engine... (Build Check: " + new Date().toISOString() + ")");
    console.log("[Main] If you do NOT see the timestamp above, your browser is serving a STALE CACHE.");
